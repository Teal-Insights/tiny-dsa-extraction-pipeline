...
class GrowthThresholdMemberMetadata(TypedDict):
    ...
    table_labels: list[dict[str, str]]
...
GROWTH_THRESHOLD_MEMBER_METADATA: tuple[GrowthThresholdMemberMetadata, ...] = (
    {
        ...
        "table_labels": [
            {"label": "Quarterly Forecast", "concept": "QUARTERLY_FORECAST"},
        ],
        "row_labels": [
            {"label": "Growth Threshold Met", "concept": "GROWTH_THRESHOLD_MET"},
        ],
        "column_labels": [{"label": "1", "concept": "REPORTING_PERIOD"}],
    },
    {
        ...
        "column_labels": [{"label": "2", "concept": "REPORTING_PERIOD"}],
    },
    {
        ...
        "column_labels": [{"label": "3", "concept": "REPORTING_PERIOD"}],
    },
    {
        ...
        "column_labels": [{"label": "4", "concept": "REPORTING_PERIOD"}],
    },
    {
        ...
        "column_labels": [{"label": "5", "concept": "REPORTING_PERIOD"}],
    },
)
